...
## 19. 축적 교환(Store and Forward Switching)
...
* 데이터 전체를 전송하는 메시지 교환과 전달 속도를 향상시키기 위해 데이터를 작은 조각으로 분할해 전송하는 패킷 교환 방식이 있다.
  ...
  ### 19-1. 메시지 교환(Meaage Switching, 전문 교환)
...
* PAD(Packet Assembler/Disassembler) : 비패킷 단말기를 패킷화하는 시스템이나 프로그램
  ...
  * 전송량이 적을 시 유리하다.
  ...
  ### 19-4. 가상 회선(Virtual Circuit) 패킷 교환
...
## 23. ISDN(종합 정보 통신망, Integrated Service Digital Network)
...
## 26. TCP(Transmission Control Protocol) 계층

## 27. IP(Internet Protocol) 계층

## 28. 주소

## 29. 인터넷 네트워크 하드웨어

## 30. OSI 모델(Open Systems Interconnection Reference Model, OSI 7계층 모형)
